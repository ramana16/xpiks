...
#  endif
    ...
    void SpellCheckWorker::processOneItem(std::shared_ptr<ISpellCheckItem> &item) {
        ...
        auto addWordItem = std::dynamic_pointer_cast<AddWordsToUserDictItem>(item);
    ...
    void SpellCheckWorker::processChangeUserDict(std::shared_ptr<AddWordsToUserDictItem> &item) {
