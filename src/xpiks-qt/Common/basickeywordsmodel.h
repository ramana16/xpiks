...
namespace Common {
    ...
    public:
        ...
        bool replaceKeywords(const QString &replaceFrom, const QStringList &keywordsList);
    ...
    private:
        ...
        bool replaceKeywordsUnsafe(const QString &replaceFrom, const QStringList &keywordsList);
