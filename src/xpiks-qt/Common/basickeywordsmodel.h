...
namespace Common {
    ...
    public:
        ...
        bool expandPreset(const QString &expandFrom, const QStringList &keywordsList);
    ...
    private:
        ...
        bool expandPresetUnsafe(const QString &expandFrom, const QStringList &keywordsList);
