...
namespace Mocks {
    ...
    public:
        virtual Models::ArtworkMetadata *createMetadata(const QString &filepath, qint64 folderID) {
            ArtworkMetadataMock *metadata = new ArtworkMetadataMock(filepath, folderID);
